            ...
            <DialogContent className="bg-[#0a0a0a] border-[#1a1a1a] text-white max-w-[400px]">
                <DialogHeader className="flex flex-col items-center gap-4 py-4">
                    ...
                    <div className="space-y-2 text-center">
                        <DialogTitle className="text-xl font-bold">Delete Credential?</DialogTitle>
                        <DialogDescription className="text-gray-400 text-sm">
                            Are you sure you want to delete credential for <span className="text-white font-medium">{credentialName}</span>?
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-red-500/10 border border-red-500/20 mb-4">
                    ...
                    <p className="text-xs text-red-200/80 leading-relaxed">
                        Deleting this credential will also affect all associated funder accounts.
                ...
                <DialogFooter className="flex gap-3 sm:justify-center">
                    ...
                    <Button
                        ...
                        disabled={isPending}
                    >
                        {isPending ? "Deleting..." : "Delete Credential"}
                    </Button>
                </DialogFooter>
            </DialogContent>
        </Dialog>
